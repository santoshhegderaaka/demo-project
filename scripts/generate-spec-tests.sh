...
if ! gh copilot suggest --help >/dev/null 2>&1; then
  echo "GitHub Copilot CLI not installed or not authenticated."
  exit 1
fi
...
git commit -m "test: add Jest unit tests generated by GitHub Copilot"
